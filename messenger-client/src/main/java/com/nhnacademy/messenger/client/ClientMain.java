...
import com.nhnacademy.messenger.client.domain.chat.ui.console.ChatConsoleListener;
import com.nhnacademy.messenger.client.domain.error.handler.ErrorResponseHandler;
import com.nhnacademy.messenger.client.domain.error.ui.console.SystemConsoleListener;
import com.nhnacademy.messenger.client.domain.room.handler.*;
import com.nhnacademy.messenger.client.domain.room.service.ChatRoomClientService;
import com.nhnacademy.messenger.client.domain.room.ui.console.RoomConsoleListener;
...
import com.nhnacademy.messenger.client.domain.user.ui.console.UserConsoleListener;
...
import com.nhnacademy.messenger.client.ui.cli.handler.ExitCommandHandler;
import com.nhnacademy.messenger.client.ui.cli.handler.HelpCommandHandler;
import com.nhnacademy.messenger.client.ui.cli.handler.QuitCommandHandler;
...
public class ClientMain {
    ...
    public static void main(String[] args) {
        ...
        EventBus.INSTANCE.register(new UserConsoleListener(view));
        EventBus.INSTANCE.register(new ChatConsoleListener(view));
        EventBus.INSTANCE.register(new RoomConsoleListener(view));
        EventBus.INSTANCE.register(new SystemConsoleListener(view));
        ...
        cliDispatcher.register(new FileTransferCommandHandler(chatRoomClientService));
        ...
        cliDispatcher.register(new ExitCommandHandler());
        cliDispatcher.register(new QuitCommandHandler());
        ...
        try {
            ...
            // 6. 입력 루프
            while (ClientSession.INSTANCE.isRunning()) {
